...
// ------------------------------ FIELDS ------------------------------
    ...
    private static final boolean PREFIX_INDEX_NAME_WITH_TABLE_NAME = true;
...
// -------------------------- OTHER METHODS --------------------------
    ...
    public Index addIndex(Session session, String indexName, int indexId,
        ...
        if (mainIndexColumn != -1) {
            ...
            MVMap<String, Info.IndexData> indices = indexStore.openMap(Info.INDICES, new MVMap.Builder<>());
    ...
    protected void readExistingIndices(Session session) {
        MVMap<String, Info.IndexData> indices = indexStore.openMap(Info.INDICES);
