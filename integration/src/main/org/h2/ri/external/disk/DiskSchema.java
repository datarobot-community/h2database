 ...
 *  <ul>
 * <li>append=true (default). Any database operation is permitted on the disk table</li>
 * <li>append=false. The table has a lifecycle:
 * <ul>
 * <li> CREATE</li>
 * <li>execute any number (including zero) of INSERT statement</li>
 * <li>execute COMMIT </li>
 * <li>now table is read only and only SELECT statements are permitted in the table.</li>
 * </ul>
 * </li>
 * </ul>
 */
...
// -------------------------- OTHER METHODS --------------------------
    ...
    protected List<String> getMembersList() {
        String[] list = new File(directory).list((dir, name) ->
                name.endsWith("." + TABLE_EXTENSION) || name.endsWith("." + VIEW_EXTENSION));
